...
#define ANYCUBIC_PROBE_VERSION 1 //Current Probe is a closing one
...
#define CUSTOM_MACHINE_NAME "ANYCUBIC Kossel LP"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 416.0 }  // default steps per unit for Kossel (GT2, 20 tooth), increased e steps for extruder to match current settings
 ...
 * Disabled because im using the pin provided by skr1.4
 */
#if ANYCUBIC_PROBE_VERSION > 0
 ...
 */
  ...
  #define NOZZLE_TO_PROBE_OFFSET { 0, 0, -3.8 } //Current Z Offset of probe is around -0.15
#elif ANYCUBIC_PROBE_VERSION == 1
  #define NOZZLE_TO_PROBE_OFFSET { 0, 0, -3.0 }
#else
...
#define Z_PROBE_FEEDRATE_FAST 36 * 60
...
#define INVERT_E0_DIR true // BMG Clone needs this to be inverted
...
#define HOMING_FEEDRATE_MM_M { (36*60), (36*60), (36*60) }
